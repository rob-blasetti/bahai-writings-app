...
export const appStyles = StyleSheet.create({
  ...
  authPrimaryActionButtonSpacing: {
    marginLeft: 12,
  },
  authPrimaryButton: {
    borderRadius: 999,
